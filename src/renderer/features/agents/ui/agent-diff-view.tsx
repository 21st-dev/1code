        ...
        >
          ...
          (isLoadingFileContents && fileDiffs.length === 0) ? (
            <div className="flex flex-col items-center justify-center h-full text-center px-4">
              <IconSpinner className="w-5 h-5 text-muted-foreground animate-spin mb-3" />
            ...
            <div className="flex flex-col items-center justify-center h-full text-center px-4">
              ...
              <p className="text-sm font-medium text-destructive mb-1">{diffError}</p>
              <Button 
                variant="outline" 
                size="sm" 
                onClick={handleRefresh}
                className="mt-3 transition-all duration-150 active:scale-[0.97] focus:ring-2 focus:ring-primary/50 focus:ring-offset-1"
              >
                Try again
              </Button>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-muted-foreground px-4 text-center h-full">
              <div className="mb-3">
                <svg
