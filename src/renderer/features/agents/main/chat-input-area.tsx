...
export const ChatInputArea = memo(function ChatInputArea({
  ...
  return (
    <div className="px-2 pb-2 shadow-lg shadow-background/50 relative z-10">
      <div className="w-full max-w-2xl mx-auto">
        ...
        >
          ...
          >
            <PromptInput
              className={cn(
                "border border-border/60 bg-input-background/95 backdrop-blur-sm relative z-10 p-2 rounded-xl transition-all duration-200 shadow-sm",
                isDragOver && "ring-2 ring-primary/50 border-primary/50 shadow-md",
                isFocused && !isDragOver && "ring-2 ring-primary/40 border-primary/40 shadow-md",
              )}
              maxHeight={200}
              onSubmit={onSend}
              contextItems={
              ...
              <PromptInputActions className="w-full">
                <div className="flex items-center gap-0.5 flex-1 min-w-0">
                  ...
                  >
                    <DropdownMenuTrigger asChild>
                      <button className="flex items-center gap-1.5 px-2 py-1 text-sm text-muted-foreground hover:text-foreground transition-all duration-150 rounded-md hover:bg-muted/60 active:bg-muted/70 active:scale-[0.98] outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70 focus-visible:ring-offset-1">
                        {isPlanMode ? (
                  ...
                  {availableModels.isOffline && availableModels.hasOllama ? (
                    ...
                    >
                      <DropdownMenuTrigger asChild>
                        <button
                          className="flex items-center gap-1.5 px-2 py-1 text-sm text-muted-foreground hover:text-foreground transition-all duration-150 rounded-md hover:bg-muted/60 active:bg-muted/70 active:scale-[0.98] outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70 focus-visible:ring-offset-1 border border-border/60"
                        >
                    ...
                    >
                      <DropdownMenuTrigger asChild>
                        <button
                          ...
                          className={cn(
                            "flex items-center gap-1.5 px-2 py-1 text-sm text-muted-foreground transition-all duration-150 rounded-md outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70 focus-visible:ring-offset-1",
                            hasCustomClaudeConfig
                              ? "opacity-70 cursor-not-allowed"
                              : "hover:text-foreground hover:bg-muted/60 active:bg-muted/70 active:scale-[0.98]",
                          )}
                        >
                ...
                <div className="flex items-center gap-0.5 ml-auto flex-shrink-0">
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-7 w-7 rounded-md transition-all duration-150 hover:bg-muted/60 active:bg-muted/70 active:scale-[0.95] outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70 focus-visible:ring-offset-1"
