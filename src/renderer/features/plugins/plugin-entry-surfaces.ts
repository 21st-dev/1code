...
const PLUGIN_ENTRY_SURFACE_MANAGE_TABS: Record<
  ...
  PluginManageTabId[]
> = {
  plugins: ["plugins", "apps", "mcps", "skills", "marketplace"],
  skills: ["skills"],
  "mcp-settings": ["mcps"],
}
...
export function getDesktopViewForSettingsIntegration(
  ...
  // Settings integration tabs render inside SettingsContent. Standalone
  // plugin/skill/MCP pages are opened from the main sidebar and deep links.
  return null
}
