      ...
      {scope === "project" && (
        <div className="space-y-1.5">
          ...
          <Select value={projectPath} onValueChange={setProjectPath}>
            <SelectTrigger>
              <SelectValue placeholder={t("settings.mcp.selectProject")} />
            </SelectTrigger>
            <SelectContent>
      ...
      {transport === "stdio" && (
        <>
          ...
          <div className="space-y-1.5">
            ...
            />
            <p className="text-[11px] text-muted-foreground">
              {t("settings.mcp.oneArgumentPerLine")}
            </p>
          </div>
          <div className="space-y-1.5">
            <Label>{t("settings.mcp.environmentVariables")}</Label>
            <textarea
              value={envText}
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-2">
              {(["none", "oauth", "bearer"] as AuthType[]).map((type) => (
                ...
                >
                  {type === "none" ? t("settings.mcp.authNone") : type === "oauth" ? "OAuth" : "Bearer Token"}
                </button>
              ))}
            </div>
          </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Input
                  ...
                  placeholder={t("settings.mcp.enterBearerToken")}
