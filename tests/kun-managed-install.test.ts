...
describe("Kun managed install", () => {
  ...
  test("renderer routes and Settings UI do not accept managed install source injection or imply shell support", () => {
    ...
    expect(settingsTab).toContain("settings.models.kunCli.install")
    expect(settingsTab).toContain("settings.models.kunCli.update")
    expect(settingsTab).toContain("settings.models.kunCli.configNeeded")
    expect(settingsTab).toContain("settings.models.kunCli.hashMismatch")
    expect(settingsTab).toContain("settings.models.kunCli.approveCurrentBuild")
