# runtime-mcp-settings-ux Specification

## Purpose
Define trustworthy Settings > MCP user-facing behavior for runtime-owned MCP
auth and connection state, especially when external runtime credential
operations fail.
## Requirements
