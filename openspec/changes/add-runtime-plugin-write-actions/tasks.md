...
## 2. Main Process API
- [x] 2.1 Add shared action, target, preview, result, and scope types.
- [x] 2.2 Add a main-process allowlist that maps typed action ids to exact Codex/Claude argv.
- [x] 2.3 Add preview and confirmed execution helpers with redaction, timeout, and minimal environment handling.
